...
//
    ...
    private boolean checkTeamPermission(Long teamId, UUID userId, String permission) {
...
//        return roleOpt.isPresent() && hasPrivilege(roleOpt.get(), permission);
    ...
    private boolean checkWorkspacePermission(Long workspaceId, UUID userId, String permission) {
...
//                .orElse(false);
    ...
    private boolean checkApartmentPermission(Long apartmentId, UUID userId, String permission) {
...
//                .orElse(false);
    ...
    private boolean checkBoardPermission(Long boardId, UUID userId, String permission) {
...
//                .orElse(false);
    ...
    private boolean checkSubBoardEntityPermission(Long entityId, String entityType, UUID userId, String permission) {
...
//                .anyMatch(p -> p.getName().equals(permission));
    ...
    private UUID getUserId(Authentication auth) {
        ...
        if (principal instanceof IamUserDetails iamUserDetails) {
            ...
            return iamUserDetails.getUserId();
        }
